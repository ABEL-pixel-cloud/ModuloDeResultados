...
public class CrearAspiranteDto {
    ...
    public CrearAspiranteDto(Long idAspirante, String tipo_De_Documento,
                             Long documento, String nombres_Completos,
                             Long telefono, String correo, String tipo_De_Perfil,
                             String estado_De_Proceso, Double resultado_Prueba_Gorilla,
                             String link_De_Prueba, Boolean admitido, String financiador,
                             String programa, String observacion) {
